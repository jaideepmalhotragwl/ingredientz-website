...
const T = {
  ...
  FR: { ingredients:"Ingrédients", products:"Produits", categories:"Catégories", about:"À propos", contact:"Contact", blog:"Blog", login:"Connexion", quote:"Demander un devis", supplier:"Devenir fournisseur", formula:"Étiquette vers Ingrédients" },
      ...
      <nav style={{ background:"white", borderBottom:"1px solid #e2e8f0", position:"sticky", top:0, zIndex:100, boxShadow:"0 1px 3px rgba(0,0,0,0.04)" }}>
        <div className="container" style={{ height:64, display:"flex", alignItems:"center", gap:24 }}>
          ...
          <div style={{ display:"flex", gap:2, marginLeft:8 }}>
            ...
            {/* Formula tool — highlighted in teal so it stands out as a feature */}
            <Link to="/formula" style={{ color:"#0EA5A0", fontSize:13, fontWeight:600, padding:"6px 12px", borderRadius:6, textDecoration:"none" }}
              onMouseEnter={e=>{e.target.style.color="#0b8a86";e.target.style.background="#f0fdfa";}}
              onMouseLeave={e=>{e.target.style.color="#0EA5A0";e.target.style.background="transparent";}}>
              {t.formula || "Label to Ingredients"}
            </Link>
          </div>
